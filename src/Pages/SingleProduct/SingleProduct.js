...
<div className="col-7">
    <ProductDetailsAndRating name="Ethyl Alcohol 70% - 1 Liter" rating="(418 Ratings)" price="EGP 35" discountedPrice="EGP 100" discountPer="-65%" shippingPrice="+ shipping from EGP 11 to 6th of October" quantity="1" />
    <>
...
<div className="main2 row container mt-3 ">
<div
  className="col-9 row single-firstcol ms-0"
  style={{ backgroundColor: "#F5F5F5", position: "relative" }}
>
...
<div className="col-3 single-secondcol">
<Aside2/>
